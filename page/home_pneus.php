...
<div class="clear"></div>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>FLOTTE AMICHE</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="https://bit.ly/3djRJ5L" target="_blank"><img width="150" height="150" src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>EUROMASTER-(Only Chrome)</b></div>
					<div class="card-block-home">
						 <a href="https://efor.euromaster-pneumatici.it/" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<p><b>User: </b>username<br></p>
					<p><b>Pass: </b>password</p>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>CARLINI-(SALZANO)</b></div>
					<div class="card-block-home">
						 <a href="https://bit.ly/3rCRvMd" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<p><b>User: </b>username<br></p>
					<p><b>Pass: </b>password</p>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>CARLINI-(S AUTOMOTIVE)</b></div>
					<div class="card-block-home">
						 <a href="https://bit.ly/3rCRvMd" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
		...
		<div class="row"><!--APRO LA SECONDA RIGA-->
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>CIAVARELLA-(SALZANO)</b></div>
					<div class="card-block-home">
						 <a href="https://bit.ly/3czMP5s" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<p><b>User: </b>username<br></p>
					<p><b>Pass: </b>password</p>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>CIAVARELLA-(S AUTOMOTIVE)</b></div>
					<div class="card-block-home">
						 <a href="https://bit.ly/3czMP5s" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
