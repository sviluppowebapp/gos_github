...
$itr1 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr1']));
$itr2 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr2']));
$itr3 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr3']));
$itr4 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr4']));
$itr5 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr5']));
$itr6 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr6']));
$itr7 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr7']));
$itr8 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr8']));
$itr9 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr9']));
$itr10 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr10']));
$itr11 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr11']));
$itr12 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr12']));
$itr13 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr13']));
$itr14 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr14']));
$itr15 = mysqli_real_escape_string($mysqli, strtoupper($_POST['itr15']));

$for1 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for1']));
$for2 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for2']));
$for3 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for3']));
$for4 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for4']));
$for5 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for5']));
$for6 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for6']));
$for7 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for7']));
$for8 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for8']));
$for9 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for9']));
$for10 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for10']));
$for11 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for11']));
$for12 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for12']));
$for13 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for13']));
$for14 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for14']));
$for15 = mysqli_real_escape_string($mysqli, strtoupper($_POST['for15']));
...
$iu3 = mysqli_real_escape_string($mysqli, $_POST['iu3']);
$iu4 = mysqli_real_escape_string($mysqli, $_POST['iu4']);
$iu5 = mysqli_real_escape_string($mysqli, $_POST['iu5']);
$iu6 = mysqli_real_escape_string($mysqli, $_POST['iu6']);
$iu7 = mysqli_real_escape_string($mysqli, $_POST['iu7']);
$iu8 = mysqli_real_escape_string($mysqli, $_POST['iu8']);
$iu9 = mysqli_real_escape_string($mysqli, $_POST['iu9']);
$iu10 = mysqli_real_escape_string($mysqli, $_POST['iu10']);
$iu11 = mysqli_real_escape_string($mysqli, $_POST['iu11']);
$iu12 = mysqli_real_escape_string($mysqli, $_POST['iu12']);
$iu13 = mysqli_real_escape_string($mysqli, $_POST['iu13']);
$iu14 = mysqli_real_escape_string($mysqli, $_POST['iu14']);
$iu15 = mysqli_real_escape_string($mysqli, $_POST['iu15']);

$sc1 = mysqli_real_escape_string($mysqli, $_POST['sc1']);
$sc2 = mysqli_real_escape_string($mysqli, $_POST['sc2']);
$sc3 = mysqli_real_escape_string($mysqli, $_POST['sc3']);
$sc4 = mysqli_real_escape_string($mysqli, $_POST['sc4']);
$sc5 = mysqli_real_escape_string($mysqli, $_POST['sc5']);
$sc6 = mysqli_real_escape_string($mysqli, $_POST['sc6']);
$sc7 = mysqli_real_escape_string($mysqli, $_POST['sc7']);
$sc8 = mysqli_real_escape_string($mysqli, $_POST['sc8']);
$sc9 = mysqli_real_escape_string($mysqli, $_POST['sc9']);
$sc10 = mysqli_real_escape_string($mysqli, $_POST['sc10']);
$sc11 = mysqli_real_escape_string($mysqli, $_POST['sc11']);
$sc12 = mysqli_real_escape_string($mysqli, $_POST['sc12']);
$sc13 = mysqli_real_escape_string($mysqli, $_POST['sc13']);
$sc14 = mysqli_real_escape_string($mysqli, $_POST['sc14']);
$sc15 = mysqli_real_escape_string($mysqli, $_POST['sc15']);

$imp_1 = mysqli_real_escape_string($mysqli, $_POST['imp_1']);
$imp_2 = mysqli_real_escape_string($mysqli, $_POST['imp_2']);
$imp_3 = mysqli_real_escape_string($mysqli, $_POST['imp_3']);
$imp_4 = mysqli_real_escape_string($mysqli, $_POST['imp_4']);
$imp_5 = mysqli_real_escape_string($mysqli, $_POST['imp_5']);
$imp_6 = mysqli_real_escape_string($mysqli, $_POST['imp_6']);
$imp_7 = mysqli_real_escape_string($mysqli, $_POST['imp_7']);
$imp_8 = mysqli_real_escape_string($mysqli, $_POST['imp_8']);
$imp_9 = mysqli_real_escape_string($mysqli, $_POST['imp_9']);
$imp_10 = mysqli_real_escape_string($mysqli, $_POST['imp_10']);
$imp_11 = mysqli_real_escape_string($mysqli, $_POST['imp_11']);
$imp_12 = mysqli_real_escape_string($mysqli, $_POST['imp_12']);
$imp_13 = mysqli_real_escape_string($mysqli, $_POST['imp_13']);
$imp_14 = mysqli_real_escape_string($mysqli, $_POST['imp_14']);
$imp_15 = mysqli_real_escape_string($mysqli, $_POST['imp_15']);
...
$messaggio = "<div class = 'container-ricerca-nulla'>";
			 "<div class ='row'><p class='btn btn-warning center-button'>Non ci sono commesse con i criteri ricercati</p></div>";
			 "</div>";

echo "<meta http-equiv='refresh' content='1;url=index.php?page=saveandpdf&id_com=$id_com'>";
...
<!-- Fine: Codice di Domenico -->
	...
	<div class="text-right">
		<button type="submit" name="submit" class="btn btn-success right">Aggiorna Commessa</button> 
	</div>
