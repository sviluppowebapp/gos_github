...
$data = mysqli_real_escape_string($mysqli, strtoupper($row['data']));
...
$totale = mysqli_real_escape_string($mysqli, strtoupper($row['totale']));
$allegato = mysqli_real_escape_string($mysqli, strtoupper($row['allegato']));
$allegato1 = mysqli_real_escape_string($mysqli, strtoupper($row['allegato1']));
$allegato2 = mysqli_real_escape_string($mysqli, strtoupper($row['allegato2']));
$allegato3 = mysqli_real_escape_string($mysqli, strtoupper($row['allegato3']));
...
$n_accettatore = mysqli_real_escape_string($mysqli, $_POST['n_accettatore']);
...
echo "<meta http-equiv='refresh' content='3;url=index.php?page=preventivopdf&id_preventivo=$id_preventivo'>";
