...
<div class="clear"></div>
		...
		<div class="row">
			 ...
			 <div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Nuovo Preventivo</b></div>
					<div class="card-block-home">
						<a href="index.php?page=inserisci_preventivo"><img src="icon/nuovo_preventivo_55.png"><br/></a>  
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Ricerca Preventivo</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="index.php?page=ricerca_preventivo"><img src="icon/ricerca_preventivo_55.png"><br/></a>     
					</div>
				</div>
			</div>			
