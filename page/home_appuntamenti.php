...
<div class="clear"></div>
		...
		<div class="col-sm-3">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Nuovo Appuntamento</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="index.php?page=inserisci_appuntamento"><img src="icon/registra_appuntamento_55.png"><br/></a>   
					</div>
				</div>
			</div>
            ...
            <div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Ricerca Appuntamento</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="index.php?page=ricerca_appuntamento"><img src="icon/ricerca_appuntamento_55.png"><br/></a>    
					</div>
				</div>
			</div>
