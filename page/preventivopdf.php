...
$accettatore = mysqli_real_escape_string($mysqli, $row['accettatore']);	
$allegato = mysqli_real_escape_string($mysqli, $row['allegato']);	
$allegato1 = mysqli_real_escape_string($mysqli, $row['allegato1']);
$allegato2 = mysqli_real_escape_string($mysqli, $row['allegato2']);
$allegato3 = mysqli_real_escape_string($mysqli, $row['allegato3']);
...
<form name="preventivo_pre_stampa" class="form" method="POST" target="_blank" action="<?php echo "pdf_preventivo.php?id_preventivo=$id_preventivo"; ?>" enctype="multipart/form-data">
